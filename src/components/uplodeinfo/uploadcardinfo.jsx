...
const UploadCardInfo = () => {
  const { commingData } = useContext(GlobalContext);
  console.log("comming data", commingData);
  return (
    <div className="my-5">
...
// const UploadCardInfo = ({ inputValue }) => {
...
//               </h1>
//               <div className="flex items-center my-1">
//                 <p className="font-semibold text-[10px]">{inputValue?.year}</p>
//               </div>
//               <p className="text-[10px]">{inputValue?.synopsis}</p>
//             </div>
//             <div className="flex gap-2 justify-end items-end ">
//               <div className="flex items-center justify-center gap-1 bg-blue-400 rounded-md  px-1 text-white font-semibold hover:bg-blue-700">
//                 <GrUpdate className="text-[12px]" />
